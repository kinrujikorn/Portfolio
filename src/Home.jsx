...
const Home = () => {
  ...
  return (
    <>
      <FadeInSection>
        <div className="slide-up">moved</div>
      </FadeInSection>
            ...
            <div id="wanjaii" className="flex items-center  space-x-22 mt-10">
              ...
              <div className="self-start w-[700px] h-[300px]">
                ...
                <a
                  ...
                  class="inline-block px-4 py-2 bg-gray-400 text-white font-medium rounded-lg shadow-md hover:bg-gray-700 hover:shadow-lg"
                >
